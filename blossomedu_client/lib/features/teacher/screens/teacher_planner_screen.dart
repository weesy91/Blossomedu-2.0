...
class _TeacherPlannerScreenState extends State<TeacherPlannerScreen> {
  ...
  Widget _buildClassCard(Map<String, dynamic> item) {
    ...
    if (subject.contains('독해') || subject.contains('READING')) {
      ...
      subjectColor = Colors
          .green; // Different color for Mock Test (Assignments are Orange)
    }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Wrap(
                          ...
                          children: [
                            _buildActionButton(
                                Icons.edit_note, '일지', Colors.green, () async {
                            ...
                            _buildActionButton(
                                Icons.calendar_month, '학생', Colors.indigo,
                                () async {
                              final studentId = student['id']?.toString();
                              if (studentId != null) {
                                await context
                                    .push('/teacher/student/$studentId');
                      ...
                      // [NEW] Log Completion Indicator (Right Aligned)
