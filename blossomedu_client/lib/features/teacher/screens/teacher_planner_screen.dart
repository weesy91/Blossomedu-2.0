    ...
    return Scaffold(
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(value: 'class', child: Text('수업만')),
              const PopupMenuItem(value: 'assignment', child: Text('과제만')),
            ],
            child: Container(
      ...
      body: _isLoading
          ...
          : Row(
              ...
              children: [
                // 1. Left Sidebar - Timeline (세로 스크롤)
                SizedBox(
                  width: 80,
                ...
                _buildActionButton(Icons.edit_note, '일지', Colors.green,
                  ...
                  if (_selectedDate.isAfter(today)) {
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text('아직 수업하지 않은 날짜의 일지는 작성할 수 없습니다.')));
                    return;
                  }
                ...
                children: [
                  ...
                  if (!isExtraClass)
                    Padding(
                      ...
                      child: Text(
                        '기존 수업일: ${DateFormat('yyyy-MM-dd').format(currentDate)} (취소됨)',
                        style: const TextStyle(
                            color: Colors.red,
                            fontWeight: FontWeight.bold,
                            fontSize: 13),
                  ...
                  ListTile(
                      ...
                      title: Text(
                          '새 날짜: ${DateFormat('yyyy-MM-dd').format(selectedDate)}'),
                  ...
                  ListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text('새 시간: ${selectedTime.format(context)}'),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'GRAMMAR', child: Text('어법 (GRAMMAR)')),
                    ],
  ...
  void _showAbsentDialog(Map<String, dynamic> student) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        title: const Text('출결 확인'),
        content: const Text('결석 처리된 학생입니다.\n일지를 작성하려면 출석 상태를 변경해야 합니다.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('취소'),
